Ext.define("App.view.main.Main", {
            ...
            items: [
                {
                    ...
                    listeners: {
                        tap: function () {
                            var me = this;
                            me.up("component[id='mainCardPanel']").onBarTap();
                        }
                    }
                },
                {
    ...
    initNavigationItems: function () {
        ...
        rCom.add(me.getTitlebar());
    },

    onDragStart: function (e) {
        var me = this;if(!me.isDrag) return false;
        me.setDuration(0);
    ...
    onDrag: function (e) {
        var me = this; if(!me.isDrag) return false;
         offset = parseInt((e.deltaX - me.dragStartOffset)); me.setDirection(e.deltaX > me.dragStartOffset ? "r" : "l");
